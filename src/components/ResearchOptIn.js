...
import { ResearchOptInModal } from '../screens/ResearchOptInModal';
        ...
        <View style={styles.row}>
          ...
          <View style={styles.textContainer}>
            ...
            <Text style={[styles.subtitle, { color: THEME.colors.textSecondary }]}>
              Partager mes rêves de façon totalement anonyme avec des chercheurs de confiance
            </Text>
          </View>
